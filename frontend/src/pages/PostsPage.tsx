    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          This page will display all blog posts with pagination, filtering, and search.
        </p>
